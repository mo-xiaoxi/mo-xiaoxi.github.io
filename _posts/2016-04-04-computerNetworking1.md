...
- HTTP和FTP的区别:
  ...
  ![image](https://momomoxiaoxi.com/img/post/comNet/3.gif)
...
![image](https://momomoxiaoxi.com/img/post/comNet/1.gif)
...
- SMTP 是推协议。因此当邮件由A发送给B的代理服务器时，B的用户代理并不能通过SMTP来从其对应的服务器取回邮件。所以得借助 POP3/IMAP/基于Web的电子邮件这类拉协议来取回。
  ![image](https://momomoxiaoxi.com/img/post/comNet/2.gif)
- 邮件转发的原理：
