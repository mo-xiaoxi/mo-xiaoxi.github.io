...
1. 了解最基本的C/S物理结构
    ...
    ![1](http://moxiaoxi.club/img/post/Web.png)
...
2. 了解基本的HTTP协议相关知识
   ...
   3. http://moxiaoxi.club/2016/01/26/NetworkAnalysis/
...
1. PHP代码审计
   ...
   http://moxiaoxi.club/img/post/Web/PHP.jpg 有点大，不加载出来了。具体可以看pdf

2. Java

   http://moxiaoxi.club/img/post/Web/JavaWeb.png
