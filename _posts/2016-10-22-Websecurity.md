...
1. 了解最基本的C/S物理结构
    ...
    ![1](https://moxiaoxi.info/img/post/Web.png)
...
2. 了解基本的HTTP协议相关知识
   ...
   3. https://moxiaoxi.info/2016/01/26/NetworkAnalysis/
...
1. PHP代码审计
   ...
   https://moxiaoxi.info/img/post/Web/PHP.jpg 有点大，不加载出来了。具体可以看pdf

2. Java

   https://moxiaoxi.info/img/post/Web/JavaWeb.png
