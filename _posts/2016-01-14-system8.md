...
![image](https://momomoxiaoxi.com/img/post/system/system16.png)
...
![image](https://momomoxiaoxi.com/img/post/system/system17.png)
...
![image](https://momomoxiaoxi.com/img/post/system/system18.png)
...
![image](https://momomoxiaoxi.com/img/post/system/system19.png)

![image](https://momomoxiaoxi.com/img/post/system/system20.png)

2. 采用分页技术不会产生外部碎片，但有内部碎片

3. 快表 TLB

 ![image](https://momomoxiaoxi.com/img/post/system/system21.png)

---

### 页表结构
#### 层次页表
 ![image](https://momomoxiaoxi.com/img/post/system/system22.png)
####  哈希页表
 ![image](https://momomoxiaoxi.com/img/post/system/system23.png)
####  反向页表
 ![image](https://momomoxiaoxi.com/img/post/system/system24.png)

---

### 分段
逻辑地址空间是由一组段组成的。每个段都有名称和长度。地址指定了段名称和段内偏移。用户可通过两个量来指定地址：段名称和偏移。（分页中，为页码和偏移）
 ![image](https://momomoxiaoxi.com/img/post/system/system25.png)
