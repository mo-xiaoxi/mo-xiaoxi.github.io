...
![6](http://momomoxiaoxi.com/img/post/TCTF2019/6.png)
...
![1](http://momomoxiaoxi.com/img/post/TCTF2019/1.png)

不过，看不到dump的数据，到这里就stuck了。
...
![2](http://momomoxiaoxi.com/img/post/TCTF2019/2.jpg)
...
![3](http://momomoxiaoxi.com/img/post/TCTF2019/3.png)
...
这个exp很奇怪，在我搭建的docker中不行，远程可以。猜测是php-fpm与php执行有一些细微差别。直接php 执行exploit.php是一定可以的。
